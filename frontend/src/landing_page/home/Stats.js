        ...
        <div className='container'>
            <div className='row'>
                <div className='col-6 p-5'>
                    ...
                    <p className='mt-3 text-muted'>That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India.</p>

                    <h2 className='mt-3 fs-4'>No spam or gimmicks</h2>
                    <p className='mt-2 text-muted'>No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like. Our philosophies.</p>

                    <h2 className='mt-3 fs-4'>The Zerodha universe</h2>
